...
"Hardware design today takes a specialist months, and docs drift from schematics until errors ship to fab. This takes one person days, with checks passing at every step. Everything's open source - the board and the workflow. [Team name, members.]"
...
"The Morse key is just what the workflow made first. The product is the workflow: hardware design at software speed, fully open."
